...
trait RetrieveFullWeekOfLessonsDaoHelper2TestCanned extends PlanWriterDaoTermlyCurriculumSelectionHelper {
  ...
  private[dao] val STATUS_COMPLETED = "COMPLETED"
  ...
  private[dao] def create5ArtEAndOsStatusesLatestComplete(): List[Document] = {
    createEAndOBenchmarksStatusDoc(TEST_USER1, TEST_CLASSA, TEST_SUBJECT_ART, TEST_TIMESTAMP_WEEK1_A,
      VALUE_TYPE_EANDO, STATUS_COMPLETED, GROUP_ID_CLASS, TEST_ART_SECTION_NAME, TEST_ART_SUBSECTION_NAME,
